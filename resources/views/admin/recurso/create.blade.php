                                    ...
                                    <li class="list-group-item">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <!-- Aqui van los form-group por individual -->
                                                <div class="form-group">
                                                    <label for="inputName" class="col-sm-6 col-form-label">Cantidad del Recurso</label>
                                                    <input type="number" name="cantidad" value="{{old('canitidad')}}" id="post-canitdad" class="@error('canitdad') is-invalid @enderror col-sm-12 form-control input-lg" placeholder="Ingresar canitdad del recurso" onkeypress="return SoloNumeros(event);" min="1" max="100">
                                                    @error('canitdad')
                                                        <div class="invalid-feedback">
                                                            {{$message}} |Solo números sin espacios.
                                                        </div>
